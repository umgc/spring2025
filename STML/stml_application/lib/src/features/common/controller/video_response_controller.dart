...
class VideoResponseController {
  ...
  static Future<VideoResponse?> addVideoResponse({
    ...
    try {
      ...
      print('Video Response Controller -- Error adding response: $e');
      return null;
    }
  }
  ...
  static Future<VideoResponse?> updateVideoResponse({
    ...
    try {
      ...
      print('Video Response Controller -- Error updating response: $e');
      return null;
    }
  }
  ...
  static Future<VideoResponse?> removeVideoResponse(int id) async {
    try {
      ...
      print('Video Response Controller -- Error removing response: $e');
      return null;
    }
  }
}
