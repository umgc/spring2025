...
class NavigationService {  
  ...
  NavigationService({  
    EmergencyService? emergencyService,  
            ...
            EmergencyService(baseUrl: 'YOUR_API_BASE_URL');  

  /// Navigates to emergency help screen and creates an emergency request  
  Future<void> navigateToEmergencyHelp(String location, DateTime timestamp) async {  
    try {  
      // Create emergency request  
      await _emergencyService.createEmergencyRequest(  
        type: EmergencyType.help,  
        location: location,  
        userId: 'CURRENT_USER_ID', // Replace with actual user ID from auth service  
      );  
  ...
  Future<void> navigateToMedicalEmergency(String location, DateTime timestamp) async {  
    try {  
