...
class EssayEditPageState extends State<EssayEditPage> {
  ...
  void populateHeadersAndRows() {
    ...
    List<dynamic> levels =
        List<dynamic>.from(mappedData['criteria']![0]['levels'] as List);
    headers = [
      {
        "title": 'Criteria',
        'index': 1,
  ...
  String getUpdatedJson() {
    ...
    Map<String, dynamic> updatedData = {"criteria": mappedData['criteria']};
        ...
        builder: (context, constraints) {
          return Column(
            ...
            children: [
              ...
              Expanded(
                child: SingleChildScrollView(
                  scrollDirection: Axis
                      .horizontal, // Allow horizontal scrolling for the Editable
                  child: ConstrainedBox(
                    constraints: BoxConstraints(
                      minWidth:
                          600, // Ensure the table never shrinks below 600px
              ...
              SizedBox(
                  height:
                      20), // Add some spacing between the Editable and the button
